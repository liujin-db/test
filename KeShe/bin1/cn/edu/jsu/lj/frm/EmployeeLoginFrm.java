...
public class EmployeeLoginFrm extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EmployeeLoginFrm frame = new EmployeeLoginFrm();
	...
	public EmployeeLoginFrm() {
		...
		btnNewButton_1.setBounds(184, 153, 97, 23);
	...
	public static boolean checkID(String id,String code){
		...
		String sql1="select id,code from Emp";
