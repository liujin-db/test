...
public class CustomerFrm extends JFrame {
	...
	public CustomerFrm() {
		...
		JButton btnNewButton = new JButton("确认消费");
			...
			public void actionPerformed(ActionEvent e) {
				...
				String number=textField_4.getText();
					if(checkID(number)==false) {
						...
						JOptionPane.showMessageDialog(null, "消费成功！工作人员马上来为您服务！");
						//写入文档
						...
						JOptionPane.showMessageDialog(null, "对不起，您位列在后面一点点，请您重新输入服务序数");
					}
			}
		});
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				CustomerSet frame1=new CustomerSet();
